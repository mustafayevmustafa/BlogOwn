            ...
            <div class="card-body">
                <form action="<?php echo e(route('admin.hero.update',1)); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="text" name="btn_text" class="form-control" value="<?php echo e($hero->btn_text); ?>">
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="text" name="btn_url" class="form-control" value="<?php echo e($hero->btn_url); ?>">
                      </div>
                    </div>
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\OwnBlog\resources\views/admin/hero/index.blade.php ENDPATH**/ ?>